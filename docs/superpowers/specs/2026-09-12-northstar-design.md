...
the STALLED fixture of section 3, inside the signature at the level configuration with no option set,
is `closed` on cards 1 and 4 and `grey` on 2, 3, 5 and 6. The smoke test (section 9) runs each null and
